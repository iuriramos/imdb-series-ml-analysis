...
class imdb_crime_series_reviews:
...
def run():
    ...
    imdb = imdb_crime_series_reviews(top=args.top, neg_rating_range=range(1, args.max_neg_rating + 1), pos_rating_range=range(args.min_pos_rating, 11))
    vectorizer_params = {
...
def run_all_settings():
    imdb = imdb_crime_series_reviews()
    dir_path = './results'
